...
describe("Persistent Node Chat Server", function() {
  ...
  xit("Dummy Test", function(done) {
    db.initialize();
    // console.log(db.addUser('Tim'));
    // console.log(db.addUser('Sam'));


    // db.getField('users','user_id','username','dave',function(results){
    //   console.log(results);
    // });
    ...
    console.log(db.escapeString("In mercy's name, three days is all I need."));
  });
